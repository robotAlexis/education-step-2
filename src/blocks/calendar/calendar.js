...
1.1. Проверка введённых дат


2. Установка месяца на основании введённых или не введённых дат

2.1. Выбор сегодняшней даты

2.2. Если обе даты введены и обе больше сегодняшней, то устанавливаем их. Иначе ставим обе как null


3. Расставляем месяц, добавляем обработчики на дни


4. Обновляем подсветку выбранных и выбираемых дней

4.1. Пробегаемся по дням из списка выбираемых элементов

4.2. Если обе даты выбраны
4.2.1. Если это начальная дата, то помечаем её как начальную выбранную клетку
4.2.2. Если дата больше начальной и меньше конечной, то помечаем клетку как просто выбранную
4.2.3. Если это конечная дата, то помечаем её как конечную выранную клетку (Она может совпадать с начальной)
4.2.4. Если дата за пределами выбранного отрезка, но курсор над ней, помечаем её как выбираемую
4.2.5. Если ни одно условие не подошло, то снимаем все выделения

4.3. Если выбрана начальная дата
4.3.1. Если это начальная дата, то помечаем её как начальную выбранную клетку
4.3.2. Если эта дата больше начальной и меньше той, над которой курсор, то помечаем её как выбранную
4.3.3. Если это дата, над которой курсор, то помечаем её как выбранную
4.3.4. Если ни одно условие не подошло, то снимаем все выделения

4.4. Если не выбрана ни одна дата
4.4.3. Если это дата, над которой курсор, то помечаем её как выбранную
4.4.4. Если ни одно условие не подошло, то снимаем все выделения
